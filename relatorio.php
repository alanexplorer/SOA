		...
		<nav class="navbar navbar-expand-sm navbar-dark bg-dark">
		 ...
		 <!-- InstanceBeginEditable name="EditRegion" -->
             <div class="py-5 text-center">
        		...
        		<p class="lead">Baixe o relatório nas opções abaixo, o relátório será gerado em pdf</p>
      		</div>
             
             <form>
                  <div class="row">
                      <div class="col-sm-2 mb-3">
                        <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Congregações">
                      </div>
                      <div class="col-sm-2 mb-3">
                       <a href="relatorios/congregacao.php" class="btn btn-primary"><i class="fa fa-download"></i> Baixar</a>
                      </div> 
                  </div>
                   <div class="row">
                      <div class="col-sm-2 mb-3">
                         <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Obreiros">
                      </div>
                      <div class="col-sm-2 mb-3">
                       <a href="relatorios/obreiro.php" class="btn btn-primary"><i class="fa fa-download"></i> Baixar</a>
                      </div> 
                  </div>
                   <div class="row">
                      <div class="col-sm-2 mb-3">
                          <input type="text" readonly class="form-control-plaintext" id="staticEmail2" value="Usuários">
                      </div>
                      <div class="col-sm-2 mb-3">
                       <a href="relatorios/congregacao.php" class="btn btn-primary"><i class="fa fa-download"></i> Baixar</a>
                      </div> 
